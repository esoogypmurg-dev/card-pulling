async function save(){
  ...
  try{
    ...
    const statsToSave = {
      ...
      weekPacksOpened: (state.stats && state.stats.weekPacksOpened) || 0,
      weekSpend: (state.stats && state.stats.weekSpend) || 0,
      weekBestPull: (state.stats && state.stats.weekBestPull) || null,
